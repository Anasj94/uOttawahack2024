...
class F2F extends Component {
  ...
  handleFlatButtonPress = () => {
    const issue = {
      'issue': "Hey!, you have a flat tyre!"
    };
 
    const payload = JSON.stringify(issue)
    // Publish dot position to a topic named 'car'
    Messaging.publish('v2v/CAR-05', payload);
    Messaging.subscribeToTopic('v2v/CAR-05')
  }
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        <button onClick={this.handleFlatButtonPress}>Hey, you have a flat tyre!</button>
      </div>
    );
  }
}
